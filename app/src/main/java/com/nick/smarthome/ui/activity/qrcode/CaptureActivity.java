...
package com.nick.smarthome.ui.activity.qrcode;
...
import com.nick.smarthome.ui.activity.picker.CommonImagePickerDetailActivity;
import com.nick.smarthome.ui.activity.picker.CommonImagePickerListActivity;
import com.nick.smarthome.ui.activity.qrcode.camera.CameraManager;
import com.nick.smarthome.ui.activity.qrcode.decode.DecodeThread;
import com.nick.smarthome.ui.activity.qrcode.decode.DecodeUtils;
import com.nick.smarthome.ui.activity.qrcode.utils.BeepManager;
import com.nick.smarthome.ui.activity.qrcode.utils.InactivityTimer;
...
//        }
        ...
        if (!result.startsWith("LI:") || result.startsWith("0",3) || result.length() > 11) {

            DialogHelp.getConfirmDialog(this, "二维码无效,请检查后重新扫!", new DialogInterface.OnClickListener() {
                @Override
       ...
       final String lockCode = result.substring(3,result.length());

        DialogHelp.getConfirmDialog(this, "确认提交锁信息:" + lockCode + "?", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void addLock(String lockCode) {
        ...
        String url = ServerApiConstants.Urls.ADD_LOCK_INFO_URLS;

        Map<String, String> params = new HashMap<String, String>();
        params.put("customerId", mCustomerId);
        params.put("lockCode", lockCode);
