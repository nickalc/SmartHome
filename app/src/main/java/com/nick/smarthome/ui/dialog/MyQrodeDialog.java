package com.nick.smarthome.ui.dialog;
...
public class MyQrodeDialog extends Dialog {
    ...
    private MyQrodeDialog(Context context, int defStyle,String str) {
...
//                    SmartHomeApplication.showToastShort("二维码已保存到oschina文件夹下");
//                } else {
//                    SmartHomeApplication.showToastShort("SD卡不可写，二维码保存失败");
//                }
                return false;
            }
        });
