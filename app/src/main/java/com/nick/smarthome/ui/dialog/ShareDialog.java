...
public class ShareDialog extends CommonDialog implements
    ...
    public void onClick(View v) {
        if (!checkCanShare()) {
            SmartHomeApplication.showToastShort("内容加载中，请稍候...");
            return;
        }
        switch (v.getId()) {
            ...
            case R.id.ly_share_more_option:
                UIHelper.showSystemShareOption((Activity) this.context,
    ...
    private UMImage getShareImg() {
        UMImage img = new UMImage(this.context, R.drawable.app_icon);
        return img;
    }
